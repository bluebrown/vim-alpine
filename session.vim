...
set ruler
set runtimepath=~/.vim,~/.vim/pack/lang/start/vim-javascript,~/.vim/pack/lang/start/jedi-vim,~/.vim/pack/lang/start/emmet-vim,~/.vim/pack/core/start/vim,~/.vim/pack/core/start/nerdtree,/usr/share/vim/vimfiles,/usr/share/vim/vim81,~/.vim/pack/lang/start/vim-javascript/after,~/.vim/pack/lang/start/jedi-vim/after,~/.vim/pack/core/start/vim/after,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
set shiftwidth=4
set showcmd
set smartindent
...
silent only
silent tabonly
cd ~/Code/desktop/utm/gatekeeper
